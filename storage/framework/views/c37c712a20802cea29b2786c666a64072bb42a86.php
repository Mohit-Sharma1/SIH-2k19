<?php $__env->startSection('page_title', 'Startups'); ?>
            ...
            <div class="block">
                <ul class="nav nav-tabs nav-tabs-block" data-toggle="tabs" role="tablist">
                    <li class="nav-item" style="width:33%;">
                        <a class="nav-link active" href="#all-startups">All</a>
                    </li>
                    <li class="nav-item" style="width:33%;">
                        <a class="nav-link" href="#ranked-startups">Ranked</a>
                    </li>
                    <li class="nav-item" style="width:33%;">
                        <a class="nav-link" href="#unranked-startups">Unranked</a>
                    </li>
                </ul>
                <div class="block-content tab-content">
                    <div class="tab-pane active" id="all-startups"" role="tabpanel">
                    <div class="row">
                        <div class="col-12 col-md-6 col-xl-6">
                            <a class="block block-link-shadow text-center" href="javascript:void(0)">
                                ...
                                <div class="block-content block-content-full block-content-sm bg-body-light">
                                    <div class="font-w600 mb-5">Startup Name</div>
                                    <div class="font-size-sm text-muted">This is a long description of the startup. This is a long description of the startup. This is a long description of the startup.</div>
                                </div>
                            </a>
                        </div>
                    </div>
                    </div>
                    <div class="tab-pane text-center" id="ranked-startups" role="tabpanel">
                        <h4 class="font-w400">Currently There Are No Ranked Startups</h4>
                        <p>...</p>
                    </div>
                    <div class="tab-pane" id="unranked-startups" role="tabpanel">
                    <div class="row">
                        <div class="col-12 col-md-6 col-xl-6">
                            <a class="block block-link-shadow text-center" href="javascript:void(0)">
                                <div class="block-content block-content-full">
