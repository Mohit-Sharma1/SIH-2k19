...
<form class="js-validation-signup px-30" method="post" action="<?php echo e(url('/register')); ?>">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-group">
        ...
        <div class="mt-30">
            <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="<?php echo e(url('/login')); ?>">
