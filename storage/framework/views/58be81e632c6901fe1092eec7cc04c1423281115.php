<?php $__env->startSection('page_title', 'Challenges'); ?>
            ...
            <div class="block">
                <ul class="nav nav-tabs nav-tabs-block" data-toggle="tabs" role="tablist">
                    <li class="nav-item" style="width:33%;">
                        <a class="nav-link active" href="#all-challenges">All</a>
                    </li>
                    <li class="nav-item" style="width:33%;">
                        <a class="nav-link" href="#ranked-challenges">Ranked</a>
                    </li>
                    <li class="nav-item" style="width:33%;">
                        <a class="nav-link" href="#unranked-challenges">Unranked</a>
                    </li>
                </ul>
                <div class="block-content tab-content">
                    <div class="tab-pane active" id="all-challenges"" role="tabpanel">
                    <div class="row">
                        <div class="col-12 col-md-6 col-xl-6">
                            <a class="block block-link-shadow text-center" href="javascript:void(0)">
                                ...
                                <div class="block-content block-content-full block-content-sm bg-body-light">
                                    <div class="font-w600 mb-5">Challenge Name</div>
                                    <div class="font-size-sm text-muted">This is a long description of the challenge. This is a long description of the challenge. This is a long description of the challenge.</div>
                                </div>
                            </a>
                        </div>
                    </div>
                    </div>
                    <div class="tab-pane text-center" id="ranked-challenges" role="tabpanel">
                        <h4 class="font-w400">Currently There Are No Ranked Challenges</h4>
                        <p>...</p>
                    </div>
                    <div class="tab-pane" id="unranked-challenges" role="tabpanel">
                    <div class="row">
                        <div class="col-12 col-md-6 col-xl-6">
                            <a class="block block-link-shadow text-center" href="javascript:void(0)">
                                <div class="block-content block-content-full">
