...
<html lang="en" class="no-focus">
    ...
    <body>
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full content-side-user px-10 align-parent">
                            ...
                            <div class="sidebar-mini-visible-b align-v animated fadeIn">
                                <img class="img-avatar img-avatar32" src="{{url('/')}}/assets/v1/img/avatars/avatar15.jpg" alt="">
                            </div>
                            ...
                            <div class="sidebar-mini-hidden-b text-center">
                                <a class="img-link" href="#">
                                    <img class="img-avatar" src="{{url('/')}}/assets/v1/img/avatars/avatar15.jpg" alt="">
                                </a>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    ...
                    <div class="float-right">
                        &copy; <?php echo date('Y'); ?>. All Rights Reserved <a class="font-w600" href="{{url('/')}}/" target="_blank">{{config('constants.app_name')}} v{{config('constants.app_version')}}</a>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
        ...
        <!-- Codebase Core JS -->
        <script type="text/javascript" src="{{url('/')}}/assets/v1/js/core/jquery.min.js"></script>
        <script type="text/javascript" src="{{url('/')}}/assets/v1/js/core/bootstrap.bundle.min.js"></script>
        <script type="text/javascript" src="{{url('/')}}/assets/v1/js/core/jquery.slimscroll.min.js"></script>
        <script type="text/javascript" src="{{url('/')}}/assets/v1/js/core/jquery.scrollLock.min.js"></script>
        <script type="text/javascript" src="{{url('/')}}/assets/v1/js/core/jquery.appear.min.js"></script>
        <script type="text/javascript" src="{{url('/')}}/assets/v1/js/core/jquery.countTo.min.js"></script>
        <script type="text/javascript" src="{{url('/')}}/assets/v1/js/core/js.cookie.min.js"></script>
        <script type="text/javascript" src="{{url('/')}}/assets/v1/js/codebase.js"></script>
